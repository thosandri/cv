...
%\vspace{0.3cm}
\cventry{Juin 2016\\à Aujourd'hui}{Ingénieur d'études}{Laboratoire de Recherche En Géodésie}{IGN/LAREG, Paris}{}{
\begin{itemize}
\item Recherche et développement d'un prototype de filtrage pour l'assimilation de données géodésiques.
\end{itemize}
}
\vspace{0.2cm}
...
%\vspace{0.3cm}
\cvdoubleitem{Environnement:}{Linux, Windows}{Web:}{Html, PHP, JavaScript}
\cvdoubleitem{Programmation:}{C++, C, Fortran 90, Python, Bash}{Logiciels:}{Matlab, Mathematica, Qgis}
\cvdoubleitem{Bibliothèques:}{Qt, OpenMP, Eigen, Numpy}{Outils:}{Git, Make, CMake, SQL}
