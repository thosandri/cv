...
%\vspace{0.3cm}
\cvdoubleitem{Environnement:}{Linux (Ubuntu), Windows}{Bureautique:}{ Office, OpenOffice, \LaTeX}
%\vspace{0.15cm}
\cvdoubleitem{Programmation:}{C++/C, Python, Fortran 90, Shell}{Web:}{HTML5, JavaScript, PHP}
%\vspace{0.15cm}
\cvdoubleitem{Logiciels:}{Matlab, Octave, Mathematica, Qt}{SIG:}{Qgis, ArcGIS, SQL}
\vspace{0.15cm}
